...
The dashboard visualizes data from the Czech Republic and other European countries for the period between 2006 and 2018. It provides graphical answers to the original research questions:
* Wage development across different industry sectors.
* Changes in purchasing power (milk and bread affordability over time).
...
1. Download the `wages_prices_dashboard.pbix` file.
